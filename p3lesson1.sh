...
stmt="INSERT INTO mysql_query_rules (active, match_pattern, replace_pattern, comment) VALUES (1, '.*pagiwhat.*$', 'SELECT sleep(5)', \"${LESSON}\"); LOAD MYSQL QUERY RULES TO RUNTIME"
mysql -vvv -u ${user} -p${password} -h 127.0.0.1  -P6032  -e "${stmt}"
echo
echo
